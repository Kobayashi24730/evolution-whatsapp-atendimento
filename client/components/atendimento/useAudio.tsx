    ...
    return(
        <div className="mt-1 flex items-center gap-3 p-2 px-3 bg-muted/30 border border-border/40 rounded-2xl max-w-xs sm:max-w-sm w-full select-none">
            <audio
                ...
                className="hidden"
            />
            <button type="button" onClick={togglePlay} className="flex items-center justify-center w-10 h-10 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-sm transition-transform active:scale-95 shrink-0">
                {isPlay ? (
